...
resource "aws_route53_record" "codifyme-web -instance2" {
  name    = "codifyme-web -instance2.example.com"
...
resource "aws_instance" "codifyme-web -instance2" {

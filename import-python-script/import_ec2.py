...
class EC2ImportSetUp:
    ...
    def describe_instance(self):
        ...
        for instance in instances:
            ...
            # Skip instances with the IAC_Managed tag set to true
            if instance_tags.get("IAC_Managed") == SkipTag.IAC_Managed.value:
                logger.info(f"Skipping Instance {instance.id} where IAC_Managed tag is set")
                continue

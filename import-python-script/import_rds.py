...
class RDSImportSetUp:
    ...
    def generate_import_blocks(self, db_instances=[], db_clusters=[]):
        ...
        for cluster in db_clusters:
            ...
            Utilities.run_terraform_cmd(["terraform", f"-chdir={self.local_repo_path}", "plan", f"-generate-config-out=generated-plan-import-{cluster['identifier']}_cluster.tf"], profile=self.aws_profile)
